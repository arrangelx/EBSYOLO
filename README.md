1.This project is optimized based on the YOLOV11 model under Ultralytics, and innovatively proposes three modules that match the required environment with Ultralytics 8.3.100 and higher versions
